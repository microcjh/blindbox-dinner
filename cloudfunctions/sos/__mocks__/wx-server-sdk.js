// cloudfunctions/sos/__mocks__/wx-server-sdk.js — 开发/测试期 mock
// 直接复用 match 同款范式（共享 ctx 链 + 支持 $ne/$in/数组包含 + doc().get() 数组形态），
// 与 common/db 的 query/getById/insert 契约完全对齐。
const store = {
  events: [
    { _id: 'e1', city: '北京', district: '朝阳', time: '2026-09-01T19:00:00Z', price: 88, capacity: 6, registered: 2, status: 'open', restaurant_id: 'r1' },
  ],
};
const seq = { n: 0 };
