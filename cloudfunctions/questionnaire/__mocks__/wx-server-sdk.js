// mock: 模拟 wx-server-sdk（questionnaire 云函数 + common/db 用到的能力）
// 与 review/match/register/events mock 同范式：collection(name) 返回共享 ctx 的链对象，方法全部 return this。
// 支持 questionnaire 用到的查询：字面量等值 / $ne / $in / 数组包含 / 分页 / 排序 / 字段裁剪 / doc 单条。
